...
coarse_rho[300:450, :] = rho_2
coarse_C11[300:450, :] = C11_2
coarse_C13[300:450, :] = C13_2
coarse_C33[300:450, :] = C33_2
coarse_C55[300:450, :] = C55_2

sch_model_coarse = sch.grid_fracture_VTI(
    coarse_C11[324:427, 199:302], coarse_C13[324:427, 199:302], coarse_C33[324:427, 199:302], coarse_C55[324:427, 199:302], seed=None
)

coarse_C11[324:427, 199:302], coarse_C13[324:427, 199:302], coarse_C33[324:427, 199:302], coarse_C55[324:427, 199:302] = sch_model_coarse

coarse_rho[450:, :] = rho_3
coarse_C11[450:, :] = C11_3
coarse_C13[450:, :] = C13_3
coarse_C33[450:, :] = C33_3
coarse_C55[450:, :] = C55_3
...
plt.imshow(coarse_imp, cmap='jet', aspect='auto', origin='upper', vmin=0.8e7, vmax=1.2e7)
cbar = plt.colorbar()
...
for idx, region in enumerate(fine_regions):
    ...
    plt.text(0.5, -0.07, f'({chr(97+0)})', 
         transform=plt.gca().transAxes,  # 使用当前axes的坐标系统
         ha='center', 
         va='top',
         fontsize=24) 
    plt.title(f"porosity = {porosity_mask.mean():.2%}", fontsize=19)
